...
const words5 = [
	...
	new Word(["to be thrilled by smth", "be thrilled by smth"], "испытывать трепет от чего-то", false),
	...
	new Word(["to groan with smth", "groan with smth"], "стонать от чего-то", false),
	new Word(["a groan", "groan"], "стон"),
	new Word(["a groan of smth", "groan of smth"], "стон чего-то", false),
	new Word(["to tremble", "tremble"], "дрожать"),
	new Word(["to tremble with smth", "tremble with smth"], "дрожать от чего-то", false),
